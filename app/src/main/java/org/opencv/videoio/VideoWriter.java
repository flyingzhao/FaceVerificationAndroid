...
public class VideoWriter {
	...
	//
	// C++: VideoWriter(String filename, int fourcc, double fps, Size frameSize,
	// bool isColor = true)
	//
	...
	//
	// C++: bool open(String filename, int fourcc, double fps, Size frameSize,
	// bool isColor = true)
	//
	...
	// C++: VideoWriter(String filename, int fourcc, double fps, Size frameSize,
	// bool isColor = true)
	private static native long VideoWriter_0(String filename, int fourcc, double fps, double frameSize_width,
			double frameSize_height, boolean isColor);

	private static native long VideoWriter_1(String filename, int fourcc, double fps, double frameSize_width,
	...
	// C++: bool open(String filename, int fourcc, double fps, Size frameSize,
	// bool isColor = true)
	private static native boolean open_0(long nativeObj, String filename, int fourcc, double fps,
			double frameSize_width, double frameSize_height, boolean isColor);

	private static native boolean open_1(long nativeObj, String filename, int fourcc, double fps,
