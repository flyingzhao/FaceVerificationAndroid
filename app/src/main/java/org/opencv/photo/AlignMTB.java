...
public class AlignMTB extends AlignExposures {
	...
	//
	// C++: void process(vector_Mat src, vector_Mat dst, Mat times, Mat
	// response)
	//
	...
	// C++: void computeBitmaps(Mat img, Mat& tb, Mat& eb)
	private static native void computeBitmaps_0(long nativeObj, long img_nativeObj, long tb_nativeObj,
			long eb_nativeObj);

	// C++: void process(vector_Mat src, vector_Mat dst, Mat times, Mat
	// response)
	private static native void process_0(long nativeObj, long src_mat_nativeObj, long dst_mat_nativeObj,
			long times_nativeObj, long response_nativeObj);
	...
	// C++: void shiftMat(Mat src, Mat& dst, Point shift)
	private static native void shiftMat_0(long nativeObj, long src_nativeObj, long dst_nativeObj, double shift_x,
			double shift_y);
