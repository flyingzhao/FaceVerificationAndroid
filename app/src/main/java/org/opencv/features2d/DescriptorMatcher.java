...
public class DescriptorMatcher {
	...
	public static final int FLANNBASED = 1, BRUTEFORCE = 2, BRUTEFORCE_L1 = 3, BRUTEFORCE_HAMMING = 4,
	...
	//
	// C++: void knnMatch(Mat queryDescriptors, Mat trainDescriptors,
	// vector_vector_DMatch& matches, int k, Mat mask = Mat(), bool
	// compactResult = false)
	//

	// javadoc: javaDescriptorMatcher::knnMatch(queryDescriptors,
	// trainDescriptors, matches, k, mask, compactResult)
	public void knnMatch(Mat queryDescriptors, Mat trainDescriptors, List<MatOfDMatch> matches, int k, Mat mask,
		...
		knnMatch_0(nativeObj, queryDescriptors.nativeObj, trainDescriptors.nativeObj, matches_mat.nativeObj, k,
				mask.nativeObj, compactResult);
	...
	//
	// C++: void knnMatch(Mat queryDescriptors, vector_vector_DMatch& matches,
	// int k, vector_Mat masks = std::vector<Mat>(), bool compactResult = false)
	//
	...
	//
	// C++: void match(Mat queryDescriptors, Mat trainDescriptors,
	// vector_DMatch& matches, Mat mask = Mat())
	//

	// javadoc: javaDescriptorMatcher::match(queryDescriptors, trainDescriptors,
	// matches, mask)
	public void match(Mat queryDescriptors, Mat trainDescriptors, MatOfDMatch matches, Mat mask) {
		Mat matches_mat = matches;
		match_0(nativeObj, queryDescriptors.nativeObj, trainDescriptors.nativeObj, matches_mat.nativeObj,
				mask.nativeObj);
	...
	//
	// C++: void match(Mat queryDescriptors, vector_DMatch& matches, vector_Mat
	...
	//
	// C++: void radiusMatch(Mat queryDescriptors, Mat trainDescriptors,
	// vector_vector_DMatch& matches, float maxDistance, Mat mask = Mat(), bool
	// compactResult = false)
	//

	// javadoc: javaDescriptorMatcher::radiusMatch(queryDescriptors,
	// trainDescriptors, matches, maxDistance, mask, compactResult)
	public void radiusMatch(Mat queryDescriptors, Mat trainDescriptors, List<MatOfDMatch> matches, float maxDistance,
		...
		Mat matches_mat = new Mat();
		radiusMatch_0(nativeObj, queryDescriptors.nativeObj, trainDescriptors.nativeObj, matches_mat.nativeObj,
				maxDistance, mask.nativeObj, compactResult);
		Converters.Mat_to_vector_vector_DMatch(matches_mat, matches);
		matches_mat.release();
		return;
	}
	...
	// javadoc: javaDescriptorMatcher::radiusMatch(queryDescriptors,
	// trainDescriptors, matches, maxDistance)
	public void radiusMatch(Mat queryDescriptors, Mat trainDescriptors, List<MatOfDMatch> matches, float maxDistance) {
		Mat matches_mat = new Mat();
		radiusMatch_1(nativeObj, queryDescriptors.nativeObj, trainDescriptors.nativeObj, matches_mat.nativeObj,
				maxDistance);
		Converters.Mat_to_vector_vector_DMatch(matches_mat, matches);
		matches_mat.release();
		return;
	...
	//
	// C++: void radiusMatch(Mat queryDescriptors, vector_vector_DMatch&
	// matches, float maxDistance, vector_Mat masks = std::vector<Mat>(), bool
	// compactResult = false)
	//

	// javadoc: javaDescriptorMatcher::radiusMatch(queryDescriptors, matches,
	...
	public void radiusMatch(Mat queryDescriptors, List<MatOfDMatch> matches, float maxDistance, List<Mat> masks,
		...
		Mat matches_mat = new Mat();
		Mat masks_mat = Converters.vector_Mat_to_Mat(masks);
		radiusMatch_2(nativeObj, queryDescriptors.nativeObj, matches_mat.nativeObj, maxDistance, masks_mat.nativeObj,
				compactResult);
		Converters.Mat_to_vector_vector_DMatch(matches_mat, matches);
		matches_mat.release();
		return;
	...
	// C++: void knnMatch(Mat queryDescriptors, vector_vector_DMatch& matches,
	// int k, vector_Mat masks = std::vector<Mat>(), bool compactResult = false)
	private static native void knnMatch_2(long nativeObj, long queryDescriptors_nativeObj, long matches_mat_nativeObj,
			int k, long masks_mat_nativeObj, boolean compactResult);

	private static native void knnMatch_3(long nativeObj, long queryDescriptors_nativeObj, long matches_mat_nativeObj,
			int k);

	// C++: void match(Mat queryDescriptors, Mat trainDescriptors,
	// vector_DMatch& matches, Mat mask = Mat())
	private static native void match_0(long nativeObj, long queryDescriptors_nativeObj, long trainDescriptors_nativeObj,
			long matches_mat_nativeObj, long mask_nativeObj);

	private static native void match_1(long nativeObj, long queryDescriptors_nativeObj, long trainDescriptors_nativeObj,
			long matches_mat_nativeObj);

	// C++: void match(Mat queryDescriptors, vector_DMatch& matches, vector_Mat
	// masks = std::vector<Mat>())
	private static native void match_2(long nativeObj, long queryDescriptors_nativeObj, long matches_mat_nativeObj,
	...
	private static native void radiusMatch_0(long nativeObj, long queryDescriptors_nativeObj,
			long trainDescriptors_nativeObj, long matches_mat_nativeObj, float maxDistance, long mask_nativeObj,
			boolean compactResult);
	...
	private static native void radiusMatch_2(long nativeObj, long queryDescriptors_nativeObj,
			long matches_mat_nativeObj, float maxDistance, long masks_mat_nativeObj, boolean compactResult);
