...
public class TrainData {
	...
	//
	// C++: Mat getTrainSamples(int layout = ROW_SAMPLE, bool compressSamples =
	...
	//
	// C++: static Ptr_TrainData create(Mat samples, int layout, Mat responses,
	// Mat varIdx = Mat(), Mat sampleIdx = Mat(), Mat sampleWeights = Mat(), Mat
	// varType = Mat())
	//
	...
	// C++: Mat getTrainSamples(int layout = ROW_SAMPLE, bool compressSamples =
	// true, bool compressVars = true)
	private static native long getTrainSamples_0(long nativeObj, int layout, boolean compressSamples,
