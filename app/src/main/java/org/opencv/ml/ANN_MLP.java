...
public class ANN_MLP extends StatModel {
	...
	public static final int BACKPROP = 0, RPROP = 1, IDENTITY = 0, SIGMOID_SYM = 1, GAUSSIAN = 2, UPDATE_WEIGHTS = 1,
	...
	//
	// C++: void setActivationFunction(int type, double param1 = 0, double
	// param2 = 0)
	//
	...
	//
	// C++: void setTrainMethod(int method, double param1 = 0, double param2 =
	// 0)
	//
