...
public class NormalBayesClassifier extends StatModel {
	...
	//
	// C++: float predictProb(Mat inputs, Mat& outputs, Mat& outputProbs, int
	// flags = 0)
	//
	...
	// C++: float predictProb(Mat inputs, Mat& outputs, Mat& outputProbs, int
	// flags = 0)
	private static native float predictProb_0(long nativeObj, long inputs_nativeObj, long outputs_nativeObj,
			long outputProbs_nativeObj, int flags);

	private static native float predictProb_1(long nativeObj, long inputs_nativeObj, long outputs_nativeObj,
			long outputProbs_nativeObj);
