...
public class EM extends StatModel {
	...
	public static final int COV_MAT_SPHERICAL = 0, COV_MAT_DIAGONAL = 1, COV_MAT_GENERIC = 2,
			COV_MAT_DEFAULT = COV_MAT_DIAGONAL, DEFAULT_NCLUSTERS = 5, DEFAULT_MAX_ITERS = 100, START_E_STEP = 1,
			START_M_STEP = 2, START_AUTO_STEP = 0;
	...
	//
	// C++: bool trainE(Mat samples, Mat means0, Mat covs0 = Mat(), Mat weights0
	// = Mat(), Mat& logLikelihoods = Mat(), Mat& labels = Mat(), Mat& probs =
	// Mat())
	//
	...
	public boolean trainE(Mat samples, Mat means0, Mat covs0, Mat weights0, Mat logLikelihoods, Mat labels, Mat probs) {
		...
		boolean retVal = trainE_0(nativeObj, samples.nativeObj, means0.nativeObj, covs0.nativeObj, weights0.nativeObj,
				logLikelihoods.nativeObj, labels.nativeObj, probs.nativeObj);
	...
	//
	// C++: bool trainEM(Mat samples, Mat& logLikelihoods = Mat(), Mat& labels =
	// Mat(), Mat& probs = Mat())
	//
	...
	public boolean trainEM(Mat samples, Mat logLikelihoods, Mat labels, Mat probs) {
		...
		boolean retVal = trainEM_0(nativeObj, samples.nativeObj, logLikelihoods.nativeObj, labels.nativeObj,
				probs.nativeObj);
	...
	//
	// C++: bool trainM(Mat samples, Mat probs0, Mat& logLikelihoods = Mat(),
	// Mat& labels = Mat(), Mat& probs = Mat())
	//
	...
	public boolean trainM(Mat samples, Mat probs0, Mat logLikelihoods, Mat labels, Mat probs) {
		...
		boolean retVal = trainM_0(nativeObj, samples.nativeObj, probs0.nativeObj, logLikelihoods.nativeObj,
	...
	// = Mat(), Mat& logLikelihoods = Mat(), Mat& labels = Mat(), Mat& probs =
	// Mat())
	private static native boolean trainE_0(long nativeObj, long samples_nativeObj, long means0_nativeObj,
			long covs0_nativeObj, long weights0_nativeObj, long logLikelihoods_nativeObj, long labels_nativeObj,
	...
	// C++: bool trainEM(Mat samples, Mat& logLikelihoods = Mat(), Mat& labels =
	// Mat(), Mat& probs = Mat())
	private static native boolean trainEM_0(long nativeObj, long samples_nativeObj, long logLikelihoods_nativeObj,
			long labels_nativeObj, long probs_nativeObj);

	private static native boolean trainEM_1(long nativeObj, long samples_nativeObj);

	// C++: bool trainM(Mat samples, Mat probs0, Mat& logLikelihoods = Mat(),
	// Mat& labels = Mat(), Mat& probs = Mat())
	private static native boolean trainM_0(long nativeObj, long samples_nativeObj, long probs0_nativeObj,
