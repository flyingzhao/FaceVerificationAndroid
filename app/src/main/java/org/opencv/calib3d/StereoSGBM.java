...
public class StereoSGBM extends StereoMatcher {
	...
	public static final int MODE_SGBM = 0, MODE_HH = 1, MODE_SGBM_3WAY = 2;

	//
	// C++: static Ptr_StereoSGBM create(int minDisparity, int numDisparities,
	// int blockSize, int P1 = 0, int P2 = 0, int disp12MaxDiff = 0, int
	// preFilterCap = 0, int uniquenessRatio = 0, int speckleWindowSize = 0, int
	// speckleRange = 0, int mode = StereoSGBM::MODE_SGBM)
	//

	// javadoc: StereoSGBM::create(minDisparity, numDisparities, blockSize, P1,
	// P2, disp12MaxDiff, preFilterCap, uniquenessRatio, speckleWindowSize,
	// speckleRange, mode)
	public static StereoSGBM create(int minDisparity, int numDisparities, int blockSize, int P1, int P2,
			int disp12MaxDiff, int preFilterCap, int uniquenessRatio, int speckleWindowSize, int speckleRange,
			int mode) {

		StereoSGBM retVal = new StereoSGBM(create_0(minDisparity, numDisparities, blockSize, P1, P2, disp12MaxDiff,
	...
	// preFilterCap = 0, int uniquenessRatio = 0, int speckleWindowSize = 0, int
	// speckleRange = 0, int mode = StereoSGBM::MODE_SGBM)
	private static native long create_0(int minDisparity, int numDisparities, int blockSize, int P1, int P2,
			int disp12MaxDiff, int preFilterCap, int uniquenessRatio, int speckleWindowSize, int speckleRange,
			int mode);
